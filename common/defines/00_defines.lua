...
NGame = {
	...
	SAVE_VERSION = 5,
	LAG_DAYS_FOR_LOWER_SPEED = 70,					-- Days of client lag for decrease of gamespeed
...
NDiplomacy = {
	...
	BASE_STAGE_COUP_TOTAL_COST = 100000, 				-- Equipment consume factor for stage coup.
	...
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.2,				-- original 0.2Each army unit owned by the source country contributes this amount of volunteers to the limit.
	...
	GUARANTEE_COST = 12,							-- Scale with the number of already guaranteed countries.
	...
	PEACE_SCORE_PER_PASS = 2,						-- When you pass in a peace deal you gain this percent of your original score
	...
	AUTONOMY_LEVEL_CHANGE_PP_FREE = 100,			-- Break free cost
...
NCountry = {
	...
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 140.0,	-- og is 10 Modifier for army manpower reinforcement delivery speed (travel time)
	...
	MIN_MANPOWER_RATIO = 0.25,						-- og is .15 Min manpower ratio to show manpower alert
	...
	PARADROP_AIR_SUPERIORITY_RATIO = 0.85,			-- og is 70% Min ratio of air superiority for paradropping
	...
	BASE_MOBILIZATION_SPEED = 0.04,					-- og is 0.1 Base speed of manpower mobilization  #in 1/1000 of 1 %
	...
	AIR_SUPPLY_CONVERSION_SCALE = 0.39,				-- Conversion scale for planes to air supply
	...
	SPECIAL_FORCES_CAP_MIN = 28,					-- og is 24 You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 4, 				-- vanilla is 5 Base factory speed multiplier (how much hoi3 style IC each factory gives).
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 500000,	-- How many deployment lines minimum can be training
	...
	MIN_LICENSE_ACTIVE_DAYS = 5,						-- Min days for license to be active
...
NTechnology = {
	...
	BASE_RESEARCH_POINTS_SAVED = 70.0,		-- Base amount of research points a country can save per slot.
...
NMilitary = {
	...
	HOURLY_ORG_MOVEMENT_IMPACT = -0.15,		-- og is -0.2 how much org is lost every hour while moving an army.
	ZERO_ORG_MOVEMENT_MODIFIER = -0.6,		-- og is -0.6 speed impact at 0 org.
	...
	RECON_SKILL_IMPACT = 8, -- og is 5 how many skillpoints is a recon advantage worth when picking a tactic.
	...
	COMBAT_MINIMUM_TIME = 2,			-- og is 2 Shortest time possible for a combat in hours
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.08,        -- og is 0.05 global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.05,        -- og is 0.05 global damage modifier
	...
	TACTIC_SWAP_FREQUENCEY = 4,                   -- og is 24: hours between tactic swaps
	...
	LEADER_SKILL_FACTOR = 0.25,                    -- og is 0.05 bonus per skill level of leader
	ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.04, --  og is 0.04 XP gain per unit in combat
	...
	BASE_LEADER_TRAIT_GAIN_XP = 1,			   -- og is 0.45 Base xp gain for traits per hour for armies
	MAX_NUM_TRAITS = 10,						   -- cant have more, -1 to disable og is -1
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.4,          -- og is -0.35 effect on defense due to enemy air superiorty
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.50,	       -- og is 0.7 more AA attack will approach this amount of help (diminishing returns)
	...
	UNIT_EXPERIENCE_PER_TRAINING_DAY = 0.0002,
	...
	EXPERIENCE_COMBAT_FACTOR = 0.15,				-- og is 0.25 this affects how each level affects the overall experience of the unit
	...
	ORG_LOSS_FACTOR_ON_CONQUER = 0.25,              -- og is 0.2 percentage of (max) org loss on takign enemy province
	...
	PLANNING_DECAY = 0.01,
	PLAYER_ORDER_PLANNING_DECAY = 0.03,				-- og is 0.08 Amount of planning lost due to player manual order
	PLANNING_GAIN = 0.02,
	...
	STRATEGIC_SPEED_BASE = 6.0,                 	-- og is 10 Speed of strategic redeployment
	...
	FIELD_MARSHAL_XP_RATIO = 0.4,					-- og is 0.25 xp gain ratio for army group leaders
	
	GARRISON_ORDER_ARMY_CAP_FACTOR = 1,			-- og is 3.0 armies gets increased cap when they are garrisoned
	...
	XP_GAIN_PER_OVERRUN_UNIT = 10.0,						-- og is 35 fixed XP gain per overrun unit
	XP_GAIN_FOR_SHATTERING = 10.0,                          -- og is 35 fixed XP gain per shattered unit
	...
	ARMY_MAX_FUEL_FLOW_MULT = 3.0,					-- og is 2.0 max fuel ratio that an army can get per hour, multiplied by supply situation
	...
	FUEL_EFFICIENCY_RAID_MULTIPLIER = 0.9,			-- convoy raid multiplier for fuel sunk
...
NAir = {
	...
	COMBAT_AMOUNT_DIFF_AFFECT_GANG_CHANCE = 0.4, 		-- og is 0.5 More aircrafts increases chance of situation 2vs1. ( Naval air combat only )
	...
	COMBAT_SITUATION_WIN_CHANCE_FROM_GANG = 0.1, 		-- og is 0.3 How much bonus gives the airplanes amount advantage (2vs1), to winning the situation.( Naval air combat only )
	...
	COMBAT_MULTIPLANE_CAP = 1.0,						-- og is 3.0 How many planes can shoot at each plane on other side ( if there are 100 planes we are atttacking COMBAT_MULTIPLANE_CAP * 100 of our planes can shoot )
	COMBAT_DAMAGE_SCALE = 0.2,							-- og is 0.1 Higher value = more shot down planes
	...
	ACCIDENT_CHANCE_BASE = 0.02,							-- og is 0.05 Base chance % (0 - 100) for accident to happen. Reduced with higher reliability stat.
	...
	AIR_COMBAT_FINAL_DAMAGE_SCALE = 0.05,               -- og is 0.0015 % how many max disrupted only planes are alloed to die in a single combat
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.75,					-- og .8 Anti Air Gun Damage factor
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.07,					-- og 0.1 Anti Air Gun hit chance
	ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.75,	-- og is 1 Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
	ANTI_AIR_MAXIMUM_DAMAGE_REDUCTION_FACTOR = 0.50,	-- og is 0.75 Maximum damage reduction factor applied to incoming air attacks against units with AA.
	...
	DISRUPTION_DEFENCE_ATTACK_FACTOR = 2.0,  -- og is 0.5
	
	CAS_NIGHT_ATTACK_FACTOR = 0.35,                      -- og is 0.1 CAS damaged get multiplied by this in land combats at night
...
NNavy = {
	...
	COMBAT_CHASE_RESIGNATION_HOURS = 16,								-- Before we resign chasing enemy, give them some minimum time so the combat doesn't end instantly.
	...
	NAVAL_TRANSFER_BASE_SPEED = 12,                                  -- og is 6 base speed of units on water being transported
	...
	CARRIER_STACK_PENALTY_EFFECT = 0.99,								-- Each carrier above the optimal amount decreases the amount of airplanes being able to takeoff by such %.
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.9,           					-- og is -0.9 effect on ship efficiency due to enemy air superiorty
...
NAI = {
	...
	MAX_VOLUNTEER_ARMY_FRACTION = 0.0001,			--og is 0.25 Countries will not send more than their forces time this number to aid another country
	...
	VP_GARRISON_VALUE_FACTOR = 2,				-- og is 0.75 Extent to which VP garrisons are prioritized, based on VP value and compared to other priority values.
	...
	PLAN_ATTACK_MIN_ORG_FACTOR_HIGH = 0.4,		-- og is 0.2
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_HIGH = 0.3,	-- og is 0.3
